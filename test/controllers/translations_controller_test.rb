...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { english: @translation.english, hebrew: @translation.hebrew, key: @translation.key } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { english: @translation.english, hebrew: @translation.hebrew, key: @translation.key } }
